...
admin.site.register(BasketballTwoPoint, MyModelAdmin)
admin.site.register(BasketballThreePoint, MyModelAdmin)
admin.site.register(BasketballFault, MyModelAdmin)
admin.site.register(BasketballRebound, MyModelAdmin)
admin.site.register(BasketballPenaltyFault, MyModelAdmin)
admin.site.register(BasketballPenaltyFailed, MyModelAdmin)
admin.site.register(BasketballSubstitute, MyModelAdmin)
admin.site.register(Photos)
admin.site.register(NewsTags, MyModelAdmin)
admin.site.register(NewsSources, MyModelAdmin)
admin.site.register(OnlineNews, MyModelAdmin)
