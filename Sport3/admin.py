...
admin.site.register(FootballHalfSeason)
admin.site.register(BasketballHalfSeason)
admin.site.register(FootballMatch)
admin.site.register(BasketballMatch)
admin.site.register(FootballTeamMembers)
admin.site.register(BasketballTeamMembers)
